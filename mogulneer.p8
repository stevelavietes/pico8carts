...
tracks = {
 { 
  ...
  course = {
   ...
   {vecmake(-32, 60),  ge_trackitem_mogul},
   {vecmake(-66, 90)},
   {vecmake(-2, 100)},
   {vecmake(12,  80)},
   {vecmake(62,  80)},
...
function make_mogul(gate_data, accum_y)
 return {
  x=gate_data[1].x,
  y=gate_data[1].y,
  space=sp_world,
 ...
 if kind == "slalom" then
  ...
  for gate in all(tracks[track_ind]["course"]) do
   if is_gate(gate) then
    ...
    add(trees, make_mogul(gate, accum_y))
   end
  end
  for i=2,#gates do
...

