...
function make_tree(loc)
 ...
 local dir_vec = vecmake(0, -segment_length)
 local dir_vec_perp = vecmake(1, 0)
 trunk_segments = {}
 for trunk_sec = 0,5 do
  ...
  local top = vecmake(0, -segment_length)
  ...
  -- if trunk_sec  == 3 then
   -- left branch
   local branch_base = vecscale(dir_vec, 0.45)
   branch_base = vecadd(branch_base, vecscale(dir_vec_perp, -current_thickness))
   local branch_tip = vecadd(branch_base, vecscale(dir_vec_perp, -3))
   branch_tip = vecadd(branch_tip, vecscale(dir_vec, -1.2))
   -- add(children, make_branch(branch_base, branch_tip, 1))
   -- right branch
   local branch_base = vecscale(dir_vec, 0.35)
   branch_base = vecadd(branch_base, vecscale(dir_vec_perp, current_thickness))
   local branch_tip = vecsub(vecscale(dir_vec_perp, 8), vecscale(dir_vec, 0.25))
   -- add(children, make_branch(branch_base, branch_tip, 1))
  end
  ...
  add(trunk_segments, {
   ...
   draw=function(t)
    drawvecline(vecmake(),t.top,t.current_thickness, 5)
    drawobjs(t.children)
   end
  })
...

...

...

__music__
00 01424344
