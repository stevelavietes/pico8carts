...
--  print("height: "..flr(scrl), 2,121)
 if g_violets[1] then
  ...
  print("m: "..mget(mp[1], mp[2]).." pos: "..mp[1]..", "..mp[2]..", flags: "..fget(mget(mp[1], mp[2])), 2, 122)
 end
 color(5)
...
function make_violet(p)
 return {
  ...
  update=function(t)
   ...
   local map_flags = fget(mget(flr(t.x), flr(t.y)), 4)
   cls()
   print(map_flags)
   if map_flags != false then
    stop()
   end
...
function map_position(o)
 ...
 local myp= flr((o.y+o.hby1-off)/8)
 local my=myp+1
...
__gfx__
00000088811000000000001881000000000000088811000000000008881100000000088811111100000008881111110000000011881100000000000000000000
...
09f009ff1881000009f009ff118100000000009ff18810000000009ff188100000009ff18881111000009ff188811110000001ff118810000000000000000000
...

...
__gff__

