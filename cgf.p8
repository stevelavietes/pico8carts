...
function make_board()
 ...
 return {
  ...
  spawn_goons=function(t, num_to_spawn)
   for i=1,num_to_spawn do
    -- pick a location
    local cell = t:random_empty_cell()
    if cell then
     local new_goon = make_goon()
     cell:now_contains(new_goon)
     add_gobjs(new_goon)
    end
   end
  end,
...
__gfx__

