...
function next_move(from_cell, to_cell)
 local path = compute_path(from_cell, to_cell)
 if path then
  return path[from_cell]
 end
end
...
-- todo use these to load the action blocks
BOARDS = {{0,0}, {0, 3}}
CURRENT_BOARD = 2

function find_board_dimensions()
 -- set global var
 BOARD_MAP_START = vecmake(
  BOARDS[CURRENT_BOARD][1],
  BOARDS[CURRENT_BOARD][2]
 )

 -- read the board dimensions
 local block_start = BOARD_MAP_START or vecmake()
 local block_end = veccopy(block_start)
 ...
 local board = {
  ...
  read_map_data=function(t)
   for c in all(t.flat_cells) do
    ...
    local map_ind = vecmget(vecadd(map_loc, BOARD_MAP_START))
    if map_ind != 0 then
...

...

__music__
00 01424344
